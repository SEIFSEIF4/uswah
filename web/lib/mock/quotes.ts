...
// ── paths ───────────────────────────────────────────────────────────────────
/**
 * SAMPLE DATA. Modelled on Motqen's مسارات: a sequence with a stated duration and
 * commitment, so somebody can see what they are agreeing to before they start.
 */
export type Path = {
  slug: string;
  tone: "ink" | "olive";
